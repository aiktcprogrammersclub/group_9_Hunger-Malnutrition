...
<meta charset="utf-8" />
	...
	<link rel="stylesheet" type="text/css" media="screen" href="css/style-online.css" />
...
<br><br>
<div style="margin-left: 75px" class="text16"><u> Registeration Form</u></div>
<div style="width: 55%; border-bottom-right-radius:20px;border-top-left-radius:20px;border-top-right-radius:20px;border-bottom-left-radius:20px; height: 800px; background:  #d0d0d0;; color:#8A0808;font-size: 25px;font-family: 'Playfair Display', serif; box-shadow:1px 3px 2px 2px #454545;margin-left: 50px; margin-top: 30px;"><br><form method="post" action="reg.php">
...
<br><br><br>&nbsp; &nbsp; &nbsp; &nbsp; Enter Password:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input id="pass1" type="password" name="pword">
<br><br><br>&nbsp; &nbsp; &nbsp; &nbsp; Confirm Password:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input id="pass2" type="password" name="cword" onChange="return myFunction()">
